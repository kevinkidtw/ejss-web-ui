...
export default function VariableBlock({ variable }: { variable: SimulationVariable }) {
  ...
  return (
    <div className="bg-yellow-400 rounded-lg p-2 shadow-md border-b-4 border-yellow-600 select-none mb-2">
      <div className="flex items-center gap-2 flex-wrap">
        <span className="text-yellow-900 font-bold text-sm">📦 模型變數</span>
        <input
          className="bg-yellow-200 text-yellow-900 font-mono text-sm px-2 py-0.5 rounded w-24 border border-yellow-500"
          value={variable.name}
          placeholder="名稱"
        ...
        />
        <select
          className="bg-yellow-200 text-yellow-900 text-sm px-1 py-0.5 rounded border border-yellow-500"
          value={variable.type}
        ...
        />
        <input
          className="bg-yellow-100 text-yellow-800 text-xs px-2 py-0.5 rounded flex-1 min-w-[80px] border border-yellow-400"
        ...
        <button
          ...
          className="text-yellow-800 hover:text-red-600 transition-colors ml-auto"
        >
